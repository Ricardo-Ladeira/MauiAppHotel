...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 950141211, ; hash 0x38a2011b, from name: MauiAppHotel
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1007282719, ; hash 0x3c09ea1f, from name: aot-MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 2080006531, ; hash 0x7bfa6183, from name: libaot-MauiAppHotel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 2743970308, ; hash 0xa38daa04, from name: MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 310
	...
	%struct.DSOCacheEntry {
		i64 2796051590, ; hash 0xa6a85c86, from name: aot-MauiAppHotel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
	...
	%struct.DSOCacheEntry {
		i64 3464121628, ; hash 0xce7a4d1c, from name: libaot-MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
