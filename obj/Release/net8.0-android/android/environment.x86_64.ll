...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3718432308579130920, ; hash 0x339a867bca31de28, from name: MauiAppHotel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 98
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7187455826258768490, ; hash 0x63bef8fe42f7326a, from name: aot-MauiAppHotel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 11070267254561852144, ; hash 0x99a17d6a4ccc4af0, from name: libaot-MauiAppHotel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 274
	...
	%struct.DSOCacheEntry {
		i64 15126212965856630132, ; hash 0xd1eb1a8ce2cad574, from name: libaot-MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 15955147859253610370, ; hash 0xdd6c1271a9a54782, from name: MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 415
	...
	%struct.DSOCacheEntry {
		i64 17504151608359923300, ; hash 0xf2eb3d2596e02e64, from name: aot-MauiAppHotel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiAppHotel.dll.so
		ptr null; void* handle (0x0)
	}, ; 452
...
@.env.3 = private unnamed_addr constant [37 x i8] c"302b82ec-8a83-4679-b22d-f84705b2df12\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.mauiapphotel\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-MauiAppHotel.dll.so\00", align 16
